    ...
    <div class="page-main-header">
        <div class="main-header-right row m-0">
            <div class="main-header-left">
                <div class="logo-wrapper"><a href="index.html"><img class="img-fluid" src="/template/admin/assets/images/logo/logo.png" alt=""></a></div>
                <div class="dark-logo-wrapper"><a href="index.html"><img class="img-fluid" src="/template/admin/assets/images/logo/dark-logo.png" alt=""></a></div>
        ...
        <footer class="footer">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <p class="pull-right mb-0">Đức Khôi - KHMT K4 <i class="fa fa-heart font-secondary"></i></p>
                    </div>
                </div>
            </div>
        </footer>
