              ...
              <div class="row">
                <div class="col-sm-6">
                  ...
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">Chuyenhd</li>
                    <li class="breadcrumb-item active">Addchuyenhd</li>
                  </ol>
                </div>
                <div class="col-sm-6">
                  <!-- Bookmark Start-->
                    ...
                    <div class="card-body">
                      <div class="row">
                        <div class="col">
                          ...
                          <div class="mb-3 row">
                            <label class="col-sm-3 col-form-label">Giá gói</label>
                            <div class="col-sm-9">
