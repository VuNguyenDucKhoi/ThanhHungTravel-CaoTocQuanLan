                    ...
                    <div class="tourmaster-payment-step-wrap" id="tourmaster-payment-step-wrap">
                        ...
                        <div class="tourmaster-payment-step-container tourmaster-container">
                            <div class="tourmaster-payment-step-inner tourmaster-item-pdlr clearfix">
                                ...
                                <div class="tourmaster-payment-step-item tourmaster-current " data-step="3"><span
                                        class="tourmaster-payment-step-item-icon"><i class="fa fa-check"></i><span
                        ...
                        <div class="tourmaster-page-content tourmaster-item-pdlr clearfix">
                            ...
                            <div class="tourmaster-tour-payment-content" id="tourmaster-tour-payment-content">
                                <div class="tourmaster-payment-contact-detail-wrap clearfix tourmaster-item-rvpdlr">
                                    <div
                                        class="tourmaster-payment-detail-wrap tourmaster-payment-contact-detail tourmaster-item-pdlr">
                                        <h3 class="tourmaster-payment-detail-title"><i class="fa fa-file-text-o"></i>Thông
                                            Tin Liên Hệ</h3>
                                        <div class="tourmaster-payment-detail"><span
                                                class="tourmaster-head">Họ Tên :</span><span
                                                class="tourmaster-tail"></span>{{$name}}</div>
                                        <div class="tourmaster-payment-detail"><span
                                                class="tourmaster-head">Email :</span><span
                                                class="tourmaster-tail">{{$email}}</span>
                                            <input type="hidden" name="email" value="{{$email}}">
                                        </div>
                                        <div class="tourmaster-payment-detail"><span
                                                class="tourmaster-head">Điện thoại :</span><span
                                                class="tourmaster-tail">{{$phone}}</span>
                                        </div>
                                        <div class="tourmaster-payment-detail"><span
                                                class="tourmaster-head">Country :</span><span
                                                class="tourmaster-tail">{{$country}}</span>
                                        </div>
                                        <div class="tourmaster-payment-detail"><span
                                                class="tourmaster-head">Địa chỉ :</span><span
                                                class="tourmaster-tail">{{$address}}</span></div>
                                    </div>
                                </div>
                                <div class="tourmaster-payment-method-wrap  tourmaster-both-online-payment">
                                    <div class="tourmaster-payment-method-booking">
                                        <a href="{{asset('dat-ve/hoan-thanh')}}"
                                            class="tourmaster-button tourmaster-payment-method-booking-button tourmaster-payment-step"
                                            data-name="payment-method" data-value="booking" data-step="4">Đặt vé</a></div>
                                </div>
                            </div>
                        </div>
                    </div>
